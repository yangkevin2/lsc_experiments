...
# example: source main.sh freesolv ../data/freesolv/freesolv.csv regression rmse 16 py27_paper_experiments py36_paper_experiments py36_paper_experiments
...
bash run_model.sh $dataName $dataType $metric $batchSize $tfenv
