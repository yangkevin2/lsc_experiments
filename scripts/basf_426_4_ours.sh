...
# wait
source main2.sh thf ../data/thf/thf.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu &
source main2.sh toluol ../data/toluol/toluol.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu & 
wait