...
# wait
source main2.sh h2o ../data/h2o/h2o.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu &
source main2.sh octanol ../data/octanol/octanol.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu & 
wait