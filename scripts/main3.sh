...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_morgan_scaffold --quiet --split_type scaffold_balanced &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan_count --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_morgan_count_scaffold --quiet --split_type scaffold_balanced &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --features_only --features_path $featuresPath --no_features_scaling --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_rdkit_scaffold --quiet --split_type scaffold_balanced &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_scaffold --quiet --split_type scaffold_balanced &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 1 --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper.json --quiet &
...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_optimized_scaffold --quiet --split_type scaffold_balanced --config_path ../ckpt/${dataName}_hyper.json &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
# echo "Scaffold"
# # gpu=$((($gpu + 1) % $numGpus))
# CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_optimized_features_scaffold --quiet --split_type scaffold_balanced --config_path ../ckpt/${dataName}_hyper.json --features_path $featuresPath --no_features_scaling &
# # echo "Time"
# # gpu=$((($gpu + 1) % $numGpus))
...
echo "Scaffold"
# gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_optimized_ensemble_scaffold --quiet --split_type scaffold_balanced --config_path ../ckpt/${dataName}_hyper.json --ensemble_size 5 &
# echo "Time"
# gpu=$((($gpu + 1) % $numGpus))
...
echo "Scaffold"
# gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --metric r2 --data_path $dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_optimized_features_ensemble_scaffold --quiet --split_type scaffold_balanced --config_path ../ckpt/${dataName}_hyper.json --features_path $featuresPath --no_features_scaling --ensemble_size 5 &
# echo "Time"
# gpu=$((($gpu + 1) % $numGpus))
