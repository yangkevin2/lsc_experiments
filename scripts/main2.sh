...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresMorganPath}.npz --save_dir ../ckpt/${dataName}_morgan_random_$i --quiet --split_type predetermined  --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --seed 3 --save_dir ../ckpt/${dataName}_rdkit_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --seed 3 --save_dir ../ckpt/${dataName}_rdkit_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
if [ "$time_split" == "true" ]
then
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/time_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
#gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --features_only --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_rdkit_time --quiet --split_type predetermined --folds_file ../../data/${dataName}/time/fold_0/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
wait
fi
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
done
wait
if [ "$time_split" == "true" ]
then
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_time_window/random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_time_window/time_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
done
echo "Time"
#gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_mpn_time --quiet  --split_type predetermined --folds_file ../../data/${dataName}/time/fold_0/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --metric $metric &
wait
fi
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path ../$dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/random/$i.json --quiet --split_type index_predetermined --crossval_index_file ../../data/${dataName}/time_window/random/fold_$i/opt_split_indices.pckl --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path ../$dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/scaffold/$i.json --quiet --split_type index_predetermined --crossval_index_file ../../data/${dataName}/time_window/scaffold/fold_$i/opt_split_indices.pckl --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path ../$dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/time/$i.json --quiet --split_type index_predetermined --crossval_index_file ../../data/${dataName}/time_window/time/fold_$i/opt_split_indices.pckl --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
done
echo "Time"
#gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path ../$dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time/0.json --quiet --split_type predetermined --folds_file ../../data/${dataName}/time/fold_0/0/split_indices.pckl --val_fold_index 1 --test_fold_index 1 --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
wait
fi
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_optimized_features_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --config_path ../ckpt/${dataName}_hyper/random/$i.json --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_optimized_features_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --config_path ../ckpt/${dataName}_hyper/scaffold/$i.json --features_path ${featuresPath}.npz --no_features_scaling --metric $metric &
done
wait
if [ "$time_split" == "true" ]
then
...
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_optimized_features_ensemble_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --config_path ../ckpt/${dataName}_hyper/random/$i.json --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --ensemble_size 5 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    #gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path ../$dataPath --dataset_type $dataType --save_dir ../ckpt/${dataName}_mpn_optimized_features_ensemble_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 --config_path ../ckpt/${dataName}_hyper/scaffold/$i.json --features_path ${featuresPath}.npz --no_features_scaling --metric $metric --ensemble_size 5 &
done
wait
if [ "$time_split" == "true" ]
then
