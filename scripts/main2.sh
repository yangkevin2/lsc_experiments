...
featuresMorganPath="../features/morgan/${dataName}.pckl"
featuresMorganCountPath="../features/morgan_count/${dataName}.pckl"
...
python save_features.py --data_path $dataPath --features_generator morgan --save_path ../$featuresMorganPath --restart
python save_features.py --data_path $dataPath --features_generator morgan_count --save_path ../$featuresMorganCountPath --restart
cd ..
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --save_dir ../ckpt/${dataName}_morgan_random_$i --quiet --split_type predetermined  --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --save_dir ../ckpt/${dataName}_morgan_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
if [ "$time_split" == "true" ]
then
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --save_dir ../ckpt/${dataName}_morgan_time_window/random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --save_dir ../ckpt/${dataName}_morgan_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --save_dir ../ckpt/${dataName}_morgan_time_window/time_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganPath --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_morgan_time --quiet --split_type predetermined --folds_file ../../data/${dataName}/time/fold_0/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
wait
fi
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --save_dir ../ckpt/${dataName}_morgan_count_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --save_dir ../ckpt/${dataName}_morgan_count_scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
if [ "$time_split" == "true" ]
then
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --save_dir ../ckpt/${dataName}_morgan_count_time_window/random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --save_dir ../ckpt/${dataName}_morgan_count_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --save_dir ../ckpt/${dataName}_morgan_count_time_window/time_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path ../$featuresMorganCountPath --num_folds 10 --seed 3 --save_dir ../ckpt/${dataName}_morgan_count_time --quiet --split_type predetermined --folds_file ../../data/${dataName}/time/fold_0/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
wait
fi
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path $featuresPath --no_features--seed 3 --save_dir ../ckpt/${dataName}_rdkit_random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path $featuresPath --no_features--seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/random_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path $featuresPath --no_features--seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_path $featuresPath --no_features--seed 3 --save_dir ../ckpt/${dataName}_rdkit_time_window/time_$i --quiet --split_type predetermined --folds_file ../../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path $dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/random/$i.json --quiet --split_type index_predetermined --crossval_index_file ../data/${dataName}/time_window/random/fold_$i/split_indices.pckl --features_path $featuresPath --no_features_scaling --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path $dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/scaffold/$i.json --quiet --split_type index_predetermined --crossval_index_file ../data/${dataName}/time_window/scaffold/fold_$i/split_indices.pckl --features_path $featuresPath --no_features_scaling --metric $metric &
    CUDA_VISIBLE_DEVICES=$gpu python hyperparameter_optimization.py --data_path $dataPath --dataset_type $dataType --num_iters $numHyperIters --config_save_path ../ckpt/${dataName}_hyper/time_window/time/$i.json --quiet --split_type index_predetermined --crossval_index_file ../data/${dataName}/time_window/time/fold_$i/split_indices.pckl --features_path $featuresPath --no_features_scaling --metric $metric &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
