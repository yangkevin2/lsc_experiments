...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan --save_dir ../ckpt/${dataName}_morgan_random_$i --quiet --split_type predetermined  --folds_file ../data/${dataName}/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
wait
echo "Scaffold"
for ((i=0;i<num_test_folds;i++)); do
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan --save_dir ../ckpt/${dataName}_morgan_time_window/random_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan --save_dir ../ckpt/${dataName}_morgan_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan --save_dir ../ckpt/${dataName}_morgan_time_window/time_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
...
for ((i=0;i<num_test_folds;i++)); do
    gpu=$((($gpu + 1) % $numGpus))
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan_count --save_dir ../ckpt/${dataName}_morgan_count_time_window/random_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/random/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan_count --save_dir ../ckpt/${dataName}_morgan_count_time_window/scaffold_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/scaffold/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
    CUDA_VISIBLE_DEVICES=$gpu python train.py --data_path $dataPath --dataset_type $dataType --features_only --features_generator morgan_count --save_dir ../ckpt/${dataName}_morgan_count_time_window/time_$i --quiet --split_type predetermined --folds_file ../data/${dataName}/time_window/time/fold_$i/0/split_indices.pckl --val_fold_index 1 --test_fold_index 2 &
done
echo "Time"
gpu=$((($gpu + 1) % $numGpus))
