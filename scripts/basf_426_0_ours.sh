...
wait
# source main2.sh dmso ../data/dmso/dmso.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu &
# source main2.sh ethanol ../data/ethanol/ethanol.csv regression 1 20 py36_paper_experiments 3 1 r2 false $gpu & 
# wait